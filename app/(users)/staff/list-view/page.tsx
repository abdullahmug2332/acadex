...
export default function StaffPage() {
  ...
  const handleDeactivate = async (id: number) => {
    try {
      ...
      fetchStaff(page);
      toast.success("Staff moved to trash successfully");
    } catch (error: any) {
                    ...
                    <TableCell>
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end">
                          ...
                          <Link href={`/staff/edit-staff/${staff.id}`}>
                            <DropdownMenuItem>
                          ...
                          <AlertDialog>
                            ...
                            <AlertDialogContent>
                              <AlertDialogHeader>
                                ...
                                <AlertDialogDescription>
                                  This action will move this staff to trash.
